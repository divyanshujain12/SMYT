...
public abstract class JCVideoPlayerTwo extends FrameLayout implements JCMediaPlayerListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener, TextureView.SurfaceTextureListener {
...
//    public static long    CLICK_QUIT_FULLSCREEN_TIME = 0;
  ...
  //  protected PlayVideoInterface playVideoInterface;
    ...
    public JCVideoPlayerTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (currentState == CURRENT_STATE_NORMAL || currentState == CURRENT_STATE_ERROR) {
                ...
                JCMediaManagerTwo.instance().mediaPlayer.pause();
                setUiWitStateAndScreen(CURRENT_STATE_PAUSE);
            } else if (currentState == CURRENT_STATE_PAUSE) {
                onEvent(JCBuriedPoint.ON_CLICK_RESUME);
                JCMediaManagerTwo.instance().mediaPlayer.start();
    ...
    public void prepareVideo() {
        ...
        JCVideoPlayerManagerTwo.putListener(this);
        addTextureView();
        ...
        JCMediaManagerTwo.instance().prepare(url, mapHeadData, looping);
        setUiWitStateAndScreen(CURRENT_STATE_PREPARING);
        if (currentState == SCREEN_LAYOUT_LIST) {
            JCVideoPlayerTwo.setCurrentScrollPlayerListener(this);
        }
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mChangePosition) {
                        ...
                        JCMediaManagerTwo.instance().mediaPlayer.seekTo(mSeekTimePosition);
    ...
    public void addTextureView() {
        ...
        JCMediaManagerTwo.textureView = null;
        JCMediaManagerTwo.textureView = new JCResizeTextureView(getContext());
        JCMediaManagerTwo.textureView.setVideoSize(JCMediaManagerTwo.instance().getVideoSize());
        JCMediaManagerTwo.textureView.setRotation(JCMediaManagerTwo.instance().videoRotation);
        JCMediaManagerTwo.textureView.setSurfaceTextureListener(this);
        ...
        FrameLayout.LayoutParams layoutParams =
                new FrameLayout.LayoutParams(
                        ...
                        ViewGroup.LayoutParams.MATCH_PARENT,
                        Gravity.CENTER);
        textureViewContainer.addView(JCMediaManagerTwo.textureView, layoutParams);
    }
    ...
    public void startProgressTimer() {
        ...
        mProgressTimerTask = new JCVideoPlayerTwo.ProgressTimerTask();
    ...
    public void onPrepared() {
        ...
        if (seekToInAdvance != -1) {
            JCMediaManagerTwo.instance().mediaPlayer.seekTo(seekToInAdvance);
            seekToInAdvance = -1;
        }
        startProgressTimer();
        setUiWitStateAndScreen(CURRENT_STATE_PLAYING);
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
    ...
    public void onCompletion() {
        ...
        JCMediaManagerTwo.instance().currentVideoWidth = 0;
        JCMediaManagerTwo.instance().currentVideoHeight = 0;

        // 清理缓存变量
        JCMediaManagerTwo.instance().bufferPercent = 0;
        JCMediaManagerTwo.instance().videoRotation = 0;
    ...
    public boolean backToOtherListener() {//这里这个名字这么写并不对,这是在回退的时候gotoother,如果直接gotoother就不叫这个名字
        ...
        if (currentScreen == JCVideoPlayerStandardTwo.SCREEN_WINDOW_FULLSCREEN
                || currentScreen == JCVideoPlayerStandardTwo.SCREEN_WINDOW_TINY) {
...
//                startAnimation(ra);
//            }
            onEvent(currentScreen == JCVideoPlayerStandardTwo.SCREEN_WINDOW_FULLSCREEN ?
                    JCBuriedPoint.ON_QUIT_FULLSCREEN :
                    JCBuriedPoint.ON_QUIT_TINYSCREEN);
            if (JCVideoPlayerManagerTwo.LISTENERLIST.size() == 1) {//directly fullscreen
                JCVideoPlayerManagerTwo.popListener().onCompletion();
                JCMediaManagerTwo.instance().releaseMediaPlayer();
                showSupportActionBar(getContext());
                return true;
            }
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
            vp.removeView(this);
            JCMediaManagerTwo.instance().lastState = currentState;//save state
            JCVideoPlayerManagerTwo.popListener();
            JCVideoPlayerManagerTwo.getFirst().goBackThisListener();
//            CLICK_QUIT_FULLSCREEN_TIME = System.currentTimeMillis();
    ...
    public void goBackThisListener() {
        ...
        currentState = JCMediaManagerTwo.instance().lastState;
    ...
    public void onBufferingUpdate(int percent) {
        if (currentState != CURRENT_STATE_NORMAL && currentState != CURRENT_STATE_PREPARING) {
            ...
            JCMediaManagerTwo.instance().bufferPercent = percent;
    ...
    public void onInfo(int what, int extra) {
        ...
        if (what == IMediaPlayer.MEDIA_INFO_BUFFERING_START) {
            JCMediaManagerTwo.instance().backUpBufferState = currentState;
            setUiWitStateAndScreen(CURRENT_STATE_PLAYING_BUFFERING_START);
            Log.d(TAG, "MEDIA_INFO_BUFFERING_START");
        } else if (what == IMediaPlayer.MEDIA_INFO_BUFFERING_END) {
            if (JCMediaManagerTwo.instance().backUpBufferState != -1) {
                setUiWitStateAndScreen(JCMediaManagerTwo.instance().backUpBufferState);
                JCMediaManagerTwo.instance().backUpBufferState = -1;
            }
            Log.d(TAG, "MEDIA_INFO_BUFFERING_END");
        } else if (what == IMediaPlayer.MEDIA_INFO_VIDEO_ROTATION_CHANGED) {
            JCMediaManagerTwo.instance().videoRotation = extra;
            JCMediaManagerTwo.textureView.setRotation(extra);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        JCMediaManagerTwo.instance().setDisplay(this.surface);
    }
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        JCMediaManagerTwo.instance().mediaPlayer.seekTo(time);
    ...
    public static boolean backPress() {
        ...
        if (JCVideoPlayerManagerTwo.getFirst() != null) {
            return JCVideoPlayerManagerTwo.getFirst().backToOtherListener();
        }
        return false;
    }
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
        ...
        try {
            ...
            JCVideoPlayerTwo jcVideoPlayer = constructor.newInstance(getContext());
...
//            jcVideoPlayer.setAnimation(ra);
            ...
            JCVideoPlayerManagerTwo.putListener(jcVideoPlayer);
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
        ...
        public void run() {
            if (currentState == CURRENT_STATE_PLAYING || currentState == CURRENT_STATE_PAUSE || currentState == CURRENT_STATE_PLAYING_BUFFERING_START) {
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        setTextAndProgress(JCMediaManagerTwo.instance().bufferPercent);
                    }
                });
            }
        }
    ...
    public int getCurrentPositionWhenPlaying() {
        ...
        if (currentState == CURRENT_STATE_PLAYING || currentState == CURRENT_STATE_PAUSE || currentState == CURRENT_STATE_PLAYING_BUFFERING_START) {
            try {
                position = (int) JCMediaManagerTwo.instance().mediaPlayer.getCurrentPosition();
    ...
    public int getDuration() {
        int duration = 0;
        try {
            duration = (int) JCMediaManagerTwo.instance().mediaPlayer.getDuration();
        } catch (IllegalStateException e) {
            e.printStackTrace();
            return duration;
        }
        ...
        public void onAudioFocusChange(int focusChange) {
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                    if (JCMediaManagerTwo.instance().mediaPlayer.isPlaying()) {
                        JCMediaManagerTwo.instance().mediaPlayer.pause();
                    }
...
//        }
    ...
    public boolean isCurrentMediaListener() {
        return JCVideoPlayerManagerTwo.getFirst() != null
                && JCVideoPlayerManagerTwo.getFirst() == this;
    }
    ...
    public void onScrollChange() {//这里需要自己判断自己是 进入小窗,退出小窗,暂停还是播放
        if (!isShown()) {
            if (JCVideoPlayerManagerTwo.getFirst() == this &&
                    url.equals(JCMediaManagerTwo.instance().mediaPlayer.getDataSource())) {
                Log.i(TAG, "onScrollChange startWindowTiny [" + this.hashCode() + "] ");
                startWindowTiny(Gravity.BOTTOM);
            }
        } else {
            if (JCVideoPlayerManagerTwo.getFirst() != this &&
                    url.equals(JCMediaManagerTwo.instance().mediaPlayer.getDataSource())) {
...
//
    ...
    public static void setCurrentScrollPlayerListener(JCMediaPlayerListener listener) {
        JCVideoPlayerManagerTwo.setCurrentScrollPlayerListener(listener);
    }
...
//                .findViewById(Window.ID_ANDROID_CONTENT);
        View old = vp.findViewById(JCVideoPlayerTwo.FULLSCREEN_ID);
        if (old != null) {
            vp.removeView(old);
        }
        try {
            Constructor<JCVideoPlayerTwo> constructor = _class.getConstructor(Context.class);
            JCVideoPlayerTwo jcVideoPlayer = constructor.newInstance(context);
            jcVideoPlayer.setId(JCVideoPlayerTwo.FULLSCREEN_ID);
    ...
    public static class JCAutoFullscreenListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {//可以得到传感器实时测量出来的变化值
            ...
            if (x < -10) {
                ...
                //direction left
                if (JCVideoPlayerManagerTwo.getFirst() != null) {
                    JCVideoPlayerManagerTwo.getFirst().autoFullscreenLeft();
                }
            } else if (y > 9.5) {
                if (JCVideoPlayerManagerTwo.getFirst() != null) {
                    JCVideoPlayerManagerTwo.getFirst().autoQuitFullscreen();
                }
            }
