...
public class JCVideoPlayerStandardTwo extends JCVideoPlayerTwo {
    ...
    protected JCVideoPlayerStandardTwo.DismissControlViewTimerTask mDismissControlViewTimerTask;


    public JCVideoPlayerStandardTwo(Context context) {
        super(context);
    }

    public JCVideoPlayerStandardTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void obtainCache() {
        Point videoSize = JCMediaManagerTwo.instance().getVideoSize();
        if (videoSize != null) {
            Bitmap bitmap = JCMediaManagerTwo.textureView.getBitmap(videoSize.x, videoSize.y);
            if (bitmap != null) {
    ...
    public void refreshCache() {
        if (pauseSwitchCoverBitmap != null) {
            JCVideoPlayerStandardTwo jcVideoPlayer = ((JCVideoPlayerStandardTwo) JCVideoPlayerManagerTwo.getFirst());
    ...
    public void onInfo(int what, int extra) {
        ...
        if (what == IMediaPlayer.MEDIA_INFO_VIDEO_ROTATION_CHANGED) {
            cacheImageView.setRotation(JCMediaManagerTwo.instance().videoRotation);
        }
    }
    ...
    public void onVideoSizeChanged() {
        ...
        cacheImageView.setVideoSize(JCMediaManagerTwo.instance().getVideoSize());
    }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (!textureSizeChanged) {
            ...
            JCMediaManagerTwo.textureView.setHasUpdated();
        } else {
...
//            localLayoutParams.y = getContext().getResources().getDimensionPixelOffset(R.dimen.jc_volume_dialog_margin_left);
    ...
    public void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new JCVideoPlayerStandardTwo.DismissControlViewTimerTask();
